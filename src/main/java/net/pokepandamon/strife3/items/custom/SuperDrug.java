...
public class SuperDrug extends CustomItem {
    ...
    public SuperDrug(String itemType, Settings settings){
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!((PlayerMixinInterface)user).onSuperDrug()) {
            ...
            user.addStatusEffect(new StatusEffectInstance(Registries.STATUS_EFFECT.getEntry(Strife3.SUPER_DRUG), 30*20, 0, true, true, true));
