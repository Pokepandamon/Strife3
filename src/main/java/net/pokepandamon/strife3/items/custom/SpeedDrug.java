...
public class SpeedDrug extends CustomItem {
    ...
    public SpeedDrug(String itemType, Settings settings){
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!((PlayerMixinInterface)user).onSpeedDrug()) {
            ...
            user.addStatusEffect(new StatusEffectInstance(Registries.STATUS_EFFECT.getEntry(Strife3.SPEED_DRUG), 120*20, 0, true, true, true));
