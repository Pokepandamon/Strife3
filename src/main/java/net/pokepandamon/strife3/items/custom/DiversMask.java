...
public class DiversMask extends CustomArmor implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public DiversMask(String itemType,RegistryEntry<ArmorMaterial> armorMaterial, Type type, Settings properties) {
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public @Nullable <T extends LivingEntity> BipedEntityModel<?> getGeoArmorRenderer(@Nullable T livingEntity, ItemStack itemStack, @Nullable EquipmentSlot equipmentSlot, @Nullable BipedEntityModel<T> original) {
                if(this.renderer == null)
                    this.renderer = new DiversMaskArmorRenderer();
