...
public class Katana extends CustomSword {
    ...
    public static final double armorToughness = 0.5;
    public static final AttributeModifiersComponent attributeModifiersComponent = AttributeModifiersComponent.builder().add(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(BASE_ATTACK_DAMAGE_MODIFIER_ID, (double)attackDamage, EntityAttributeModifier.Operation.ADD_VALUE), AttributeModifierSlot.MAINHAND)
                                                                                    ...
                                                                                    .add(EntityAttributes.GENERIC_ARMOR_TOUGHNESS, new EntityAttributeModifier(Identifier.of(Strife3.MOD_ID, "armor_toughness"), armorToughness, EntityAttributeModifier.Operation.ADD_VALUE), AttributeModifierSlot.MAINHAND)
    ...
    public Katana(String itemType, ToolMaterials toolMaterials, Settings settings) {
