...
public class StrengthDrug extends CustomItem {
    ...
    public StrengthDrug(String itemType, Settings settings){
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!((PlayerMixinInterface)user).onStrengthDrug()) {
            ...
            user.addStatusEffect(new StatusEffectInstance(Registries.STATUS_EFFECT.getEntry(Strife3.STRENGTH_DRUG), 60*20, 0, true, true, true));
